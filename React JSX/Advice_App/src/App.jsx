      ...
      <div className="w-full max-w-xl">
        ...
        <div className="relative bg-white/20 backdrop-blur-xl border border-white/30 rounded-3xl p-8 shadow-2xl">
          ...
          <ul className="relative flex justify-center items-center gap-5 mb-10">
            ...
            <li className={`${step == 1 ? "bg-gradient-to-br from-yellow-400 to-orange-500 text-white" : " bg-white/20 border border-white/40 text-white"} w-14 h-14 rounded-full text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-orange-500/40 hover:scale-110 transition duration-300 cursor-pointer`}>
              1
            </li>

            <div className="w-12 h-1 bg-white/40 rounded-full"></div>

            <li className={`${step == 2 ? "bg-gradient-to-br from-yellow-400 to-orange-500 text-white" : " bg-white/20 border border-white/40 text-white"} w-14 h-14 rounded-full text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-orange-500/40 hover:scale-110 transition duration-300 cursor-pointer`}>
              2
            </li>
